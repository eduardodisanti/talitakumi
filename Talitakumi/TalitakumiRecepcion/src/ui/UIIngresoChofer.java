 ...
 * @author victoria
 */
public class UIIngresoChofer extends javax.swing.JFrame {

    public Integer getCodigo1;

    /** Creates new form UIIngresoChofer */
    public UIIngresoChofer() {
        initComponents();
...
//        return Integer.parseInt(st.nextToken());
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Ingreso Chofer");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(scrollUtil, javax.swing.GroupLayout.DEFAULT_SIZE, 905, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        getAccessibleContext().setAccessibleName("Chequeos - Ingreso Chofer");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UIIngresoChofer().setVisible(true);
            }
        });
    }
