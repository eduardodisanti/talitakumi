...
public class IngresoCtrl extends AbstractVisualController {

    private UIIngresoRecepcion panel;
    ...
    public IngresoCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIIngresoRecepcion();
