 ...
 * @author rupertus
 */
public class ReintegroCtrl extends AbstractVisualController {

    private UIReintegro panel;
    ...
    public ReintegroCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIReintegro();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 21);
