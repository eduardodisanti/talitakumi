 ...
 * @author rupertus
 */
public class EgresoCtrl extends AbstractVisualController {

    private UIEgreso panel;
    ...
    public EgresoCtrl() throws Exception {
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 20);
