 ...
 * @author rupertus
 */
public class PesoYTallaCtrl extends AbstractVisualController {

    private UIPesoYTalla panel;
    ...
    public PesoYTallaCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIPesoYTalla();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 39);
