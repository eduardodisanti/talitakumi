 ...
 * @author rupertus
 */
public class ConsultaMedicaCtrl extends AbstractVisualController {

    private UIConsultaMedica panel;
    ...
    public ConsultaMedicaCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIConsultaMedica();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 24);
