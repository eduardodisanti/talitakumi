 ...
 * @author rupertus
 */
public class ChequeoArmasCtrl extends AbstractVisualController {

    private UIChequeoArmas panel;
    ...
    public ChequeoArmasCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIChequeoArmas();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 40);
