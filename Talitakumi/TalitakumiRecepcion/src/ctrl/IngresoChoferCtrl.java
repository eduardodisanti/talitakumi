 ...
 * @author rupertus
 */
public class IngresoChoferCtrl extends AbstractVisualController {

    private UIIngresoChofer panel;
    ...
    public IngresoChoferCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIIngresoChofer();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 16);
