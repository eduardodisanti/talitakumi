 ...
 * @author rupertus
 */
public class SantanderCtrl extends AbstractVisualController {

    private UISantander panel;
    ...
    public SantanderCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UISantander();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 18);
