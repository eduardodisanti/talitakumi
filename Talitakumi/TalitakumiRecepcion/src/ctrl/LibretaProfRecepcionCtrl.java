...
import ui.UILibretaProfRecepcion;
 ...
 * @author rupertus
 */
public class LibretaProfRecepcionCtrl extends AbstractVisualController {

    private UILibretaProfRecepcion panel;
    ...
    public LibretaProfRecepcionCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UILibretaProfRecepcion();
...
//    public char habilitadoUrgente() throws Exception {
//
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Libretaprofesional lp = new Libretaprofesional();
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 8);
            ...
            //dp.set("inmediato", false); // TODO - Cambiar
            dp.set("actividad", lp);
            ...
            result = (HashMap) Sesion.getServiceDelegatorRemote().invoke("ServicioGuardarSolicitudLibretaProfesional", dp);
                System.out.println("Cantidad de result es " + result.size());
            ...
            if(result == null) {
                ...
                info = "Error LibretaRecepcionCtrl";
                  ...
                  info = "<h2>Pasado a laboratorio " + "</h2>";
