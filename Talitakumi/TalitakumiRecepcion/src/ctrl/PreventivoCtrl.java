 ...
 * @author rupertus
 */
public class PreventivoCtrl extends AbstractVisualController {

    private UIPreventivo panel;
    ...
    public PreventivoCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIPreventivo();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 17);
