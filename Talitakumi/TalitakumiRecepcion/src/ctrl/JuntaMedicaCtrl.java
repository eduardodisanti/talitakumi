 ...
 * @author rupertus
 */
public class JuntaMedicaCtrl extends AbstractVisualController {

    private UIJuntaMedica panel;
    ...
    public JuntaMedicaCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIJuntaMedica();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 22);
