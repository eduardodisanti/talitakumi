...
import talitakumi.model.core.Psicotecnicos;
import talitakumi.servicios.ConvertPersona;
import ui.UIPsicotecnicosRecepcion;
 ...
 * @author rupertus
 */
public class PsicotecnicosRecepcionCtrl extends AbstractVisualController {

    private UIPsicotecnicosRecepcion panel;
    ...
    private Psicotecnicos psico;


    public PsicotecnicosRecepcionCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIPsicotecnicosRecepcion();
    ...
    public void guardarDatos() throws Exception {
       ...
       String puesto = panel.getPuesto();
       System.out.println("PUESTO ES " +panel.getPuesto());
       String tipodeconsulta = panel.getTipodeconsulta();
       System.out.println("TIPO DE CONSULTA ES " +panel.getTipodeconsulta());

       int a = 0;
       if(tipodeconsulta.equals("1RA VEZ"))
           a = 10;
        else
            if(tipodeconsulta.equals("REVISION"))
                a = 37;
            else
                if(tipodeconsulta.equals("RENOVACION"))
                    a = 38;
       ...
       System.out.println("!!!!!!!!!!!!!!!!!!!!!! A ES  :" +a);
        ...
        if(validarDatos(p)) {
            Psicotecnicos ldc = new Psicotecnicos();
            ...
            ldc.setPuesto(puesto);
            ldc.setTipodeconsulta(tipodeconsulta);
            ...
            Actividades act;
            System.out.println("!!!!!!!!!!!!!!!!!!!!!! AA ES  :" +a);
            if(a==10)
                 act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 10);
            else if(a==37)
                 act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 37);
            else if(a==38)
                 act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 38);
            else{
                System.out.println("Hay un error");
                act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 100);
            }            
            System.out.println("!!!!!!!!!!!!!!!!!!!!!! ACT ES  :" +a);
            ...
            result = (HashMap) Sesion.getServiceDelegatorRemote().invoke("ServicioGuardarSolicitudPsicotecnico", dp);
