...
import ui.UIChequeoPersonalizado;
 ...
 * @author rupertus
 */
public class ChequeoPersonalizadoCtrl extends AbstractVisualController {

    private UIChequeoPersonalizado panel;
    ...
    public ChequeoPersonalizadoCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIChequeoPersonalizado();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 35);
