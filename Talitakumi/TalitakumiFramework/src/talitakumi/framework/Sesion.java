...
public class Sesion {
     ...
     private static ServiceDelegatorRemote servicedelegatorremote;
    ...
    public static void setServiceDelegatorRemote(ServiceDelegatorRemote sdr) {
