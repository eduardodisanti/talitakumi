 ...
 * @author rupertus
 */
public class ServicioGuardarSolicitudCopiaLaboratorio implements AbstractService {
    ...
    public ServicioGuardarSolicitudCopiaLaboratorio() {
    ...
    public Object invoke(Object o) {
        ...
        try {
         ...
         // Meto la agenda
                ...
                a.setAgendaPK(apk);
                a.setActividad(12); // TODO sacarlo del hardcode
                a.setVino('S');
                a.setHabilitado('S');
