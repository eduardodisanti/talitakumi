 ...
 * @author rupertus
 */
public class ServicioGuardarSolicitudPsicotecnico implements AbstractService {

    private Psicotecnicos ldc;
    ...
    public ServicioGuardarSolicitudPsicotecnico() {
    ...
    public void setParameters(Object o) {
        ...
        ldc = (Psicotecnicos) dp.get("actividad");
    ...
    public Object invoke(Object o) {
        ...
        try {
         ...
         // Meto la agenda
                ...
                a.setAgendaPK(apk);
                a.setActividad(10); // TODO sacarlo del hardcode
                a.setVino('S');
                a.setHabilitado('S');
