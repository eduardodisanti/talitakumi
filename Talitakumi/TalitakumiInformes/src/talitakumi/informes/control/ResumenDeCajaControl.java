 ...
 * @author rupertus
 */
public class ResumenDeCajaControl {


    Logger logger;
     public ResumenDeCajaControl(Date fechadesde, Date fechahasta, int idusuario) {
     ...
     public void listar(Date fechadesde, Date fechahasta, int idusuario) {
         ...
         new Reporter("ResumenDeCajaEfectivoTotal.jasper").listar(m);
