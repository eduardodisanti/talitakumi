 ...
 * @author rupertus
 */
public class CarnetxprocedenciafactcredCtrl {


    Logger logger;
     public CarnetxprocedenciafactcredCtrl(Date fechadesde, Date fechahasta, DataParameter dp) {
     ...
     public void listar(Date fechadesde, Date fechahasta, DataParameter dp) {
         ...
         new Reporter("carnetxprocedenciafactcred.jasper").listar(m);
     }
}