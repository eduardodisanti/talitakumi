 ...
 * @author rupertus
 */
public class LPRxprocedenciafactcredCtrl {


    Logger logger;
     public LPRxprocedenciafactcredCtrl(Date fechadesde, Date fechahasta, DataParameter dp) {
     ...
     public void listar(Date fechadesde, Date fechahasta, DataParameter dp) {
         ...
         new Reporter("LPRxprocedenciafactcredCliente.jasper").listar(m);
     }
}