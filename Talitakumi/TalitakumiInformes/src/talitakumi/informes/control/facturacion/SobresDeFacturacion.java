 ...
 * @author victoria
 */
public class SobresDeFacturacion {

    public SobresDeFacturacion (Date fechadesde, Date fechahasta, DataParameter dp){
         ...
         new Reporter("SobresFacturacion.jasper").listar(m);
