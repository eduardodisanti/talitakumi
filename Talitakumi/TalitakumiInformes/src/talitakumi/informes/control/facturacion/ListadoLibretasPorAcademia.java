 ...
 * @author victoria
 */
public class ListadoLibretasPorAcademia {

    public ListadoLibretasPorAcademia (Date fechadesde, Date fechahasta, DataParameter dp){
         ...
         new Reporter("NuevoListadoPorAcademia.jasper").listar(m);
