 ...
 * @author rupertus
 */
public class ListadodeventascontadoCtrl {


    Logger logger;
     public ListadodeventascontadoCtrl(Date fechadesde, Date fechahasta, DataParameter dp) {
     ...
     public void listar(Date fechadesde, Date fechahasta, DataParameter dp) {
         ...
         new Reporter("listadoventascontado.jasper").listar(m);
     }
}