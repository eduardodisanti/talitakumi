 ...
 * @author victoria
 */
public class InformeProductividadOdontologos {

    public InformeProductividadOdontologos (Date fechadesde, Date fechahasta){
         ...
         new Reporter("InformeProductividadODO.jasper").listar(m);
