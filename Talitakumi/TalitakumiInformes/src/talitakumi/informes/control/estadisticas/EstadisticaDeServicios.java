 ...
 * @author rupertus
 */
public class EstadisticaDeServicios {


    Logger logger;
     public EstadisticaDeServicios(Date fechadesde, Date fechahasta, DataParameter dp) {
     ...
     public void listar(Date fechadesde, Date fechahasta, DataParameter dp) {
         ...
         System.out.println("Parametros : " + sfechadesde + "," + sfechahasta);
         new Reporter("estadisticadeservicios.jasper").listar(m);
     }
}