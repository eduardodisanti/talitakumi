 ...
 * @author victoria
 */
public class CarneSaludTipoProcedencia {

        public CarneSaludTipoProcedencia(Date fechadesde, Date fechahasta, DataParameter dp)
 {
        HashMap m = new HashMap();
         ...
         new Reporter("CarneSaludTipoProcedencia.jasper").listar(m);
