...
public class UICarnetDeSalud extends javax.swing.JPanel {
    ...
    private void initComponents() {
            ...
            .add(jPanel7Layout.createSequentialGroup()
                .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel7Layout.createSequentialGroup()
                        .add(jLabel35)
                        .add(2, 2, 2)
                        .add(jcbDomicilio3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 406, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jLabel45.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jLabel46.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jLabel48.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel48.setText("ALERGIAS");

        jLabel52.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        jLabel55.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel55.setText("PLEUROPULMONARES");

        jLabel56.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel56.setText("DIGESTIVOS");

        jLabel57.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel57.setText("RENALES");

        jLabel58.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel58.setText("OSTEOARTICULARES");

        jLabel59.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel59.setText("OFTALMOLOGICOS");

        jLabel60.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel60.setText("NEUROLOGICOS");

        antsiquiatricos.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        internaciones.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        internaciones.setText("INTERNACIONES");
        internaciones.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        antecedentesauditivos.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        antquirurgicos.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        jLabel9.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel9.setText("PIEL Y MUCOSAS");

        jLabel12.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        jLabel64.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        actividadesfisicas.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        cuello.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        effosaslumbares.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        efosteoarticular.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        efosteoarticular.setText("OSTEOARTICULAR");
        efosteoarticular.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);

        efsectormuscular.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        perimetroabdominal.setModel(new javax.swing.SpinnerNumberModel(60, 30, 240, 5));
        ...
        jLabel19.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        jLabel20.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        ...
        jLabel65.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        tifoidea.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        tifoidea.setText("VAC.TIFOIDEA");
        tifoidea.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        jLabel23.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel23.setText("PLEUROPULMONAR");

        jLabel24.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel24.setText("MAMAS");

        jLabel25.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel25.setText("ABDOMEN");

        jLabel26.setText("CICATRIZ");

        jLabel67.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel67.setText("VENOSO");

        jLabel66.setFont(new java.awt.Font("Lucida Grande", 3, 14));
        jLabel66.setText("ZONAS HERNARIAS");

        imc.setEditable(false);
        imc.setText("200");

        jLabel69.setFont(new java.awt.Font("Lucida Grande", 0, 8));
        jLabel69.setText("National Cholesterol Program U.S.A");

        jLabel70.setFont(new java.awt.Font("Lucida Grande", 0, 8));
        ...
        jLabel73.setFont(new java.awt.Font("Lucida Grande", 2, 13));
                    ...
                    .add(jPanel2Layout.createSequentialGroup()
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel2Layout.createSequentialGroup()
                                ...
                                .add(mav)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                                .add(pleuropulmonar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 662, Short.MAX_VALUE))
                            .add(jPanel2Layout.createSequentialGroup()
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(jPanel2Layout.createSequentialGroup()
                                        .add(jLabel67)
                                    ...
                                    .add(jLabel66))
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)))
                        .add(296, 296, 296))))
            .add(jPanel2Layout.createSequentialGroup()
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel2Layout.createSequentialGroup()
        ...
        otorgadoanterior.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        otorgadovence.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel2, 0, 984, Short.MAX_VALUE)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(399, 399, 399)
                        .add(almacenar))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
