 ...
 * UIEmisores.java
 *
 * Created on 23-ago-2012, 12:28:33
 */
 ...
 */
public class UIEmisores extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT e FROM Emisor e");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${rut}"));
        columnBinding.setColumnName("Rut");
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.rut}"), rutField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), rutField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(rutField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .add(nombreField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .add(layout.createSequentialGroup()
                .addContainerGap()
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                UIEmisores.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                UIEmisores.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                UIEmisores.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                UIEmisores.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<talitakumi.admin.Emisor> toRemove = new ArrayList<talitakumi.admin.Emisor>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            talitakumi.admin.Emisor e = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(e);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        talitakumi.admin.Emisor e = new talitakumi.admin.Emisor();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<talitakumi.admin.Emisor> merged = new ArrayList<talitakumi.admin.Emisor>(list.size());
            for (talitakumi.admin.Emisor e : list) {
    ...
    private java.util.List<talitakumi.admin.Emisor> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new UIEmisores());
