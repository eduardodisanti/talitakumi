 ...
 * @author rupertus
 */
public class UIPuestoDeTrabajo extends javax.swing.JDialog {
    public Integer getCodigo1;

    /** Creates new form UILibretaRecepcion */
    public UIPuestoDeTrabajo() {
        initComponents();
        this.setModal(true);
    }
...
//        return Integer.parseInt(st.nextToken());
    ...
    private void initComponents() {
        ...
        jLabel17.setText("PUESTO DE TRABAJO");
        ...
        setBounds((screenSize.width-934)/2, (screenSize.height-531)/2, 934, 531);
