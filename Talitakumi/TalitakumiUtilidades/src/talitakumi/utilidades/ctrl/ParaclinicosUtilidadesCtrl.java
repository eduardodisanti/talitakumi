...
import talitakumi.utilidades.ui.UIParaclinicosUtilidades;
 ...
 * @author rupertus
 */
public class ParaclinicosUtilidadesCtrl extends AbstractVisualController {

    private UIParaclinicosUtilidades panel;
    ...
    public ParaclinicosUtilidadesCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIParaclinicosUtilidades();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            dp1.set("pasaAconsultorio", false);
            dp1.set("externo", true);
            ...
            if(result == null) {
                ...
                msg = "Error interno - no se pudo almacenar -";
