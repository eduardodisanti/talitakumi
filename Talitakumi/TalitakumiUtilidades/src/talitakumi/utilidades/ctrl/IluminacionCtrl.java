...
import talitakumi.utilidades.ui.UIIluminacion;
 ...
 * @author rupertus
 */
public class IluminacionCtrl extends AbstractVisualController {

    private UIIluminacion panel;
    ...
    public IluminacionCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIIluminacion();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 31);
