...
import talitakumi.utilidades.ui.UIVacunasUtilidades;
 ...
 * @author rupertus
 */
public class VacunasUtilidadesCtrl extends AbstractVisualController {

    private UIVacunasUtilidades panel;
    ...
    public VacunasUtilidadesCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIVacunasUtilidades();
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            if(result == null) {
                    ...
                    info = "Error invocando ServicioGuardarSolicitudVacunas<br><h2>INFORMAR</h2>";
                    logger.error("Error invocando GuardarSolicitudVacunas cedula : " + p.getDocumento() + " " + info);
                } else {
