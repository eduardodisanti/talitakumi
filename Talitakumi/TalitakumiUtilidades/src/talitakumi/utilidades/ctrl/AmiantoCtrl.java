...
import talitakumi.utilidades.ui.UIAmianto;
 ...
 * @author rupertus
 */
public class AmiantoCtrl extends AbstractVisualController {

    private UIAmianto panel;
    ...
    public AmiantoCtrl() throws Exception {
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 26);
