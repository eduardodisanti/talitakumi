...
import talitakumi.utilidades.ui.UIAgentesQuimicos;
 ...
 * @author rupertus
 */
public class AgentesQuimicosCtrl extends AbstractVisualController {

    private UIAgentesQuimicos panel;
    ...
    public AgentesQuimicosCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIAgentesQuimicos();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 25);
