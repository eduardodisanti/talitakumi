...
import talitakumi.utilidades.ui.UIMonitoreoBiologico;
 ...
 * @author rupertus
 */
public class MonitoreoBiologicoCtrl extends AbstractVisualController {

    private UIMonitoreoBiologico panel;
    ...
    public MonitoreoBiologicoCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIMonitoreoBiologico();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 33);
