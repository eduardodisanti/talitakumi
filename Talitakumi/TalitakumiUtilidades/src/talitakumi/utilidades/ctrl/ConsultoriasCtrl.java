...
import talitakumi.utilidades.ui.UIConsultorias;
 ...
 * @author rupertus
 */
public class ConsultoriasCtrl extends AbstractVisualController {

    private UIConsultorias panel;
    ...
    public ConsultoriasCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIConsultorias();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 41);
