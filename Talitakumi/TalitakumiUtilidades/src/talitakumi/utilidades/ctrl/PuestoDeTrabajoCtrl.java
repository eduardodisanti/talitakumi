...
import talitakumi.utilidades.ui.UIPuestoDeTrabajo;
 ...
 * @author rupertus
 */
public class PuestoDeTrabajoCtrl extends AbstractVisualController {

    private UIPuestoDeTrabajo panel;
    ...
    public PuestoDeTrabajoCtrl() throws Exception {

        result = null;
        this.logger = Sesion.getLogger();
        panel = new UIPuestoDeTrabajo();
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 28);
