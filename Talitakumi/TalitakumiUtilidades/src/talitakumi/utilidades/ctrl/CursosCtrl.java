...
import talitakumi.utilidades.ui.UICursos;
 ...
 * @author rupertus
 */
public class CursosCtrl extends AbstractVisualController {

    private UICursos panel;
    ...
    public CursosCtrl() throws Exception {
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 30);
