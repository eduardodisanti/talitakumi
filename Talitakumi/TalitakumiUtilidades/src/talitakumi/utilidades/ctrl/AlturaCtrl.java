...
import talitakumi.utilidades.ui.UIAltura;
 ...
 * @author rupertus
 */
public class AlturaCtrl extends AbstractVisualController {

    private UIAltura panel;
    ...
    public AlturaCtrl() throws Exception {
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 19);
