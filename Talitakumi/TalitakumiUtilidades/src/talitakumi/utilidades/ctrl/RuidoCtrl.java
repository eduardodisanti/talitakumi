...
import talitakumi.utilidades.ui.UIRuido;
 ...
 * @author rupertus
 */
public class RuidoCtrl extends AbstractVisualController {

    private UIRuido panel;
    ...
    public RuidoCtrl() throws Exception {
    ...
    public void guardarDatos() throws Exception {
       ...
       Personas p = obtenerPersona(cedula);
        ...
        if(validarDatos(p)) {
            ...
            Actividades act = (Actividades) Sesion.getServiceDelegatorRemote().invoke("ServicioCargarActividad", 29);
