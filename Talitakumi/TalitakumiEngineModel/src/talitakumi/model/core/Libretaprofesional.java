 ...
 */
@Entity
@Table(name = "libretaprofesional")
@NamedQueries({
    @NamedQuery(name = "Libretaprofesional.findAll", query = "SELECT l FROM Libretaprofesional l"),
    @NamedQuery(name = "Libretaprofesional.findByEpisodio", query = "SELECT l FROM Libretaprofesional l WHERE l.episodio = :episodio")})
public class Libretaprofesional implements Serializable {
    ...
    public Libretaprofesional(Integer episodio) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Libretaprofesional)) {
            return false;
        }
        Libretaprofesional other = (Libretaprofesional) object;
    ...
    public String toString() {
        return "talitakumi.model.core.Libretaprofesional[episodio=" + episodio + "]";
    }
